...
<head>
    ...
    <!-- Favicon icon -->
    <title>Patient Dashboard - The Ultimate Multipurpose</title>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="dropdown-divider"></div>
                                <a data-toggle="modal" data-target="#myPass" class="dropdown-item" href="javascript:void(0)"><i class="ti-lock m-r-5 m-l-5"></i> Change Password</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-move-resize-variant"></i><span class="hide-menu">Addons </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{ route('home') }}" class="sidebar-link"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"> Dashboard </span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">Settings </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a data-toggle="modal" data-target="#myPass" href="#" class="sidebar-link"><i class="fa fa-lock"></i><span class="hide-menu">
                                     Change Password </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('profile') }}" class="sidebar-link"><i class="fa fa-user"></i><span class="hide-menu"> Account Setting</span></a></li>
                                <li class="sidebar-item"><a href="#" class="sidebar-link"><i class="fa fa-user"></i><span class="hide-menu"> My profile </span></a></li>
            ...
            <!-- ============================================================== -->
             <div class="page-breadcrumb">
                <div class="row">
                    ...
                    @endif
                        {{-- &nbsp;&nbsp;<span class="text-success">Welcome  {!! Auth::user()->surname. " ". Auth::user()->firstname !!}!</span>  --}}
                  ...
                  <form action="{{ route('changePassword') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                            ...
                            <input id="oldPassword" type="password" value="{{ old('oldPassword') }}"
                             ...
                             form-control-lg" placeholder="Current Password" aria-label="Password"
                      ...
                      <div class="input-group mb-3">
                            ...
                            <input id="password" type="password" class="@error('newPassword') is-invalid @enderror form-control 
